...
{
	return BindCol(paramIndex, SQL_C_TINYINT, size32(bool), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, float* value, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_FLOAT, size32(float), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, double* value, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_DOUBLE, size32(double), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, int8* value, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_TINYINT, size32(int8), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, int16* value, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_SHORT, size32(int16), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, int32* value, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_LONG, size32(int32), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, int64* value, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_SBIGINT, size32(int64), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, TIMESTAMP_STRUCT* value, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_TIMESTAMP, size32(TIMESTAMP_STRUCT), value, index);
}

bool DBConnection::BindCol(int32 paramIndex, const WCHAR* str, int32 size, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_C_WCHAR, size, (SQLPOINTER)str, index);
}

bool DBConnection::BindCol(int32 paramIndex, const BYTE* bin, int32 size, SQLLEN* index)
{
	return BindCol(paramIndex, SQL_BINARY, size, (BYTE*)bin, index);
}
